...
import matplotlib
# matplotlib.use("Agg")
# ('C:\Users\MichaelGe\Desktop\מיכאל תשפב\לימודים תשפב\Subjects\Design and Visualization of a Transmission Line for a novel THz Free Electron Laser (FEL)\240722\3D MODE (Ex_{TE_2_3}).csv')
...
def plot_3d_to_2d(X, Y, Z, name='Plot'):
    ...
    plt.savefig("C:/Users/michaelge/Desktop/WDPG/" + name_func + '.png')
...
ax.plot_surface(X, Y, Z/np.abs(Z).max(), rstride=1, cstride=1, cmap='viridis', edgecolor='none', label='Rays Intensity')
...
ax.yaxis._axinfo['label']['space_factor'] = 3.0
plt.savefig("C:/Users/michaelge/Desktop/WDPG/" + 'GAUSS1000mm' + '.png')
plt.show()
plt.close('all')
