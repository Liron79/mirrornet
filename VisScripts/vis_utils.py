...
def plot_metrics(X: np.array, Y: np.array, Z: np.array, path: str, title: str = str(),
    ...
    ax.set_title(title)
    ax.set_xlabel(x_label, fontsize=10, weight='semibold', rotation=-10)
    ax.set_ylabel(y_label, fontsize=10, weight='semibold', rotation=45)
    ax.set_zlabel(z_label, fontsize=10, weight='semibold', rotation=90)
